...
/**
     ...
     * @returns {CropperShade} Returns `this` for chaining.
     */$render(){return this.$setStyles({transform:`translate(${this.x}px, ${this.y}px)`,width:this.width,height:this.height,outlineWidth:c.innerWidth})}}CropperShade.$name=l;CropperShade.$version="2.0.0";export{CropperShade as default};
